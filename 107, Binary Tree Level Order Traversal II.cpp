...
int main() {
    ...
    Solution s1;
    vector<vector<int>> result1 = s1.levelOrderBottom(root1);
    cout << "Expected Output: [[15,7], [9,20], [3]]" << endl;
    cout << "Your Output: ";
    printResult(result1);
    cout << endl;
    ...
    Solution s2;
    vector<vector<int>> result2 = s2.levelOrderBottom(root2);
    ...
    Solution s3;
    vector<vector<int>> result3 = s3.levelOrderBottom(root3);
