...
int main() {
    ...
    Solution s1;
    vector<vector<int>> result1 = s1.levelOrder(root1);
    cout << "Expected Output: [[3], [9,20], [15,7]]" << endl;
    cout << "Your Output: ";
    printResult(result1);
    cout << endl;
    ...
    Solution s2;
    vector<vector<int>> result2 = s2.levelOrder(root2);
    ...
    Solution s3;
    vector<vector<int>> result3 = s3.levelOrder(root3);
